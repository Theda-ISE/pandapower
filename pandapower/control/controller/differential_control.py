...
class DifferentialControl(DynamicControl):
    """
    Class representing a PID- differential time series controller for specified elements and variables.

    """

    def __init__(self, net, ctrl_element, ctrl_variable, ctrl_element_index, pv_max, pv_min, prev_mv=100, integral=0, dt=1,
        ...
        if matching_params is None:
            matching_params = {"element": ctrl_element, "variable": ctrl_variable,
                               "element_index": ctrl_element_index}
        ...
        self.ctrl_variable = ctrl_variable
        ...
        self.applied = False
        self.write_flag, self.variable = _detect_read_write_flag(net, ctrl_element, ctrl_element_index, ctrl_variable)
